...
//A utility function I wrote to change the second half of a string to be red. This is to show a negative change in "change" that comes back when looking up a stock
public func changeSecondHalfToRed(stringToSplitAndColor: String) -> NSMutableAttributedString {
